						...
						<ul class="main-menu">
                            ...
                            : '' }}">
								...
								<ul class="slide-menu child1 {{ request()->is('admin/leads*') ? 'active' : '' }}">
									...
									<li class="slide {{ request()->is('admin/leads*')? 'active' : '' }}">
										<a href="{{route('admin.leads.index')}}" class="side-menu__item">Leads</a>
									</li>
									<li class="slide">
                            ...
                            : '' }}">
								...
								<ul class="slide-menu child1 {{ request()->is('admin/inventory*') ? 'active' : '' }}">
									...
									<li class="slide {{ request()->is('admin/inventory/page1*')? 'active' : '' }}">
										<a href="{{route('admin.inventory.page1')}}" class="side-menu__item">Page 1</a>
									</li>
									<li class="slide {{ request()->is('admin/inventory/page2*')? 'active' : '' }}">
										<a href="{{route('admin.inventory.page2')}}" class="side-menu__item">Page 2</a>
									</li>
								</ul>
							</li>
							<!-- End::slide -->
